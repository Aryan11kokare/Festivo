...
import { getAllTickets } from "../redux/actions/eventActions";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-cyan-50 ">
      ...
      <section className=" w-full sm:px-10">
        <div className="h-full px-6 py-4 flex flex-col justify-start items-start ">
          <h4 className="font-bold text-xl" htmlFor="review">
            Your Bookings
          </h4>
          <div className="mt-4 h-full border w-full rounded-md p-4 ">
            {tickets.map((ticket) => {
